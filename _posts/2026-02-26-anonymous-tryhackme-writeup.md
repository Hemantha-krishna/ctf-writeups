...
image: "https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/anonymous-tryhackme-writeup/img-000-66592b4f.png"
---
...
This room is a classic boot-to-root challenge designed for beginners to practice enumeration, exploiting misconfigured services, and performing privilege escalation on a Linux target.![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/anonymous-tryhackme-writeup/img-000-66592b4f.png)
...
The scan reveals **4 open ports**.![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/anonymous-tryhackme-writeup/img-001-cad5d7c8.png)
...
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/anonymous-tryhackme-writeup/img-002-6bb130b2.png)

Connecting to the share:
```bash
smbclient //<MACHINE_IP>/pics -U anonymous
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/anonymous-tryhackme-writeup/img-003-53ff8e71.png)
...
ftp <MACHINE_IP>
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/anonymous-tryhackme-writeup/img-004-59f4276a.png)
...
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/anonymous-tryhackme-writeup/img-005-d09a4592.png)
...
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/anonymous-tryhackme-writeup/img-006-bc626b55.png)
...
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/anonymous-tryhackme-writeup/img-007-77bbc0e9.png)

After uploading the modified `clean.sh` back to the FTP server, we set up a listener on our local machine: `nc -lvnp 4444`![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/anonymous-tryhackme-writeup/img-008-ef8dc5f2.png)

Within a minute, the cron job executes the script, and we receive a shell as the user `namelessone.`

**User Flag:** Found in `/home/namelessone/user.txt`![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/anonymous-tryhackme-writeup/img-009-4c4d8cc2.png)
...
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/anonymous-tryhackme-writeup/img-010-32a16491.png)

The results show that `/usr/bin/env` has the SUID bit set. According to **GTFOBins**, `env` can be used to escalate privileges if the SUID bit is present.![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/anonymous-tryhackme-writeup/img-011-d0313725.png)
...
env /bin/sh -p
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/anonymous-tryhackme-writeup/img-012-6db9ad6e.png)
