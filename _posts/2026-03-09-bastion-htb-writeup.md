...
image: "https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-000-ff16b44b.png"
---
...
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-001-e05964b7.png)
...
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-002-76ec2c9b.png)
...
It works without a password. Inside we find a `note.txt` and a `WindowsImageBackup` directory.![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-003-06ba2122.png)

The note warns sysadmins not to transfer the entire backup locally due to VPN speed — conveniently, we don’t have to.![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-004-7e8eb9ec.png)

### Mounting the VHD Without Downloading It

The `WindowsImageBackup` folder contains a Windows backup for a user called **L4mpje-PC**, including two `.vhd` (Virtual Hard Disk) files.![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-005-bdcf3c66.png)
...
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-006-390ca7f2.png)![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-007-b979e94b.png)
...
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-008-048ea6db.png)![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-009-253ebe47.png)![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-010-86043db4.png)![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-011-eb40ff21.png)
...
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-012-39ccf017.png)
...
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-013-f6d47bc5.png)

We crack the hashes with hashcat against rockyou:![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-014-a145ed2c.png)
```bash
hashcat -m 1000 hashes.txt /usr/share/wordlists/rockyou.txt
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-015-37b607f7.png)
...
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-016-ed37b14d.png)

We land in a Windows command prompt. The user flag is sitting on the Desktop:
```bash
C:\Users\L4mpje\Desktop> type user.txt
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-017-598cef6f.png)

### Privilege Escalation — mRemoteNG Password Extraction

Checking installed software in `Program Files (x86)`, we notice **mRemoteNG version 1.76.11** — a remote connection manager known to store credentials in an encrypted (but breakable) format.![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-018-13aead9d.png)
...
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-019-9de1df83.png)

Reading `confCons.xml` reveals an XML node for an **Administrator** connection with an AES-GCM encrypted password field.![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-020-35a7784e.png)![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-021-eb93cf98.png)
...
The password is revealed in plaintext.![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-022-45a71d4c.png)
...
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-023-ca23fce5.png)

We’re in as Administrator. The root flag is on the Desktop:
```bash
C:\Users\Administrator\Desktop> type root.txt
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/bastion-htb-writeup/img-024-d9615161.png)
