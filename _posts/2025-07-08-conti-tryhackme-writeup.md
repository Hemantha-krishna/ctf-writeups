...
image: "https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/conti-tryhackme-writeup/img-000-60facfbb.jpg"
---
...
An Exchange server was compromised with ransomware. Use Splunk to investigate how the attackers compromised the server.![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/conti-tryhackme-writeup/img-000-60facfbb.jpg)

Room: <https://tryhackme.com/room/contiransomwarehgh>![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/conti-tryhackme-writeup/img-001-d5d0cbb1.png)
...
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/conti-tryhackme-writeup/img-002-a41cfce0.png)
...
**Exchange Control Panel**:![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/conti-tryhackme-writeup/img-003-49005d17.png)

**Outlook Web Access**:![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/conti-tryhackme-writeup/img-004-d3a643c7.png)
...
Next, let’s look at the sysmon logs![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/conti-tryhackme-writeup/img-005-6f046364.png)
...
We get 2,000+ hits. Let’s look at the CurrentDirectory Filter; there are 5 directories. Our answer is one among them![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/conti-tryhackme-writeup/img-006-2dafb183.png)
...
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/conti-tryhackme-writeup/img-007-c30884d1.png)
...
Then, I navigated to the first event with cmd.exe. In the details, I found the hash.![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/conti-tryhackme-writeup/img-008-18167b76.png)
...
After scrolling a bit, I found cmd.exe saving a readme.txt file in multiple locations. This readme is the ransom note we saw earlier.![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/conti-tryhackme-writeup/img-009-fca2b977.png)

### What was the command the attacker used to add a new user to the compromised system?

event ID 4720 is triggered when a new user account is created. When I searched, I found 2 events![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/conti-tryhackme-writeup/img-010-cfd5492c.png)

If we take a look at the latest event, the first event, I found out that the username of the account is *securityninja.* Then I searched for it, and I got 10 events. I navigated to the first occurrence and found the command used to create the user.![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/conti-tryhackme-writeup/img-011-273baaf9.png)
...
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/conti-tryhackme-writeup/img-012-91bf62f1.png)
...
```
![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/conti-tryhackme-writeup/img-013-03b6fb62.png)
...
then, i looked at the *cs\_url\_stem* and found the aspx file![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/conti-tryhackme-writeup/img-014-6327d164.png)

### What is the command line that executed this web shell?

From the previous found event, we can get the full command![image](https://raw.githubusercontent.com/Hemantha-krishna/ctf-images/main/conti-tryhackme-writeup/img-015-b9840d3b.png)
